 ...
 * Uses the AtlasConvert API for accurate, source-backed conversions.
 *
 * @example
 *   import { convertHistorical } from 'atlasconvert-historical';
 *
 ...
 *
 *   console.log(result);
 *   // { from: 'roman_denarius', to: 'usd', result: 120.00, context: '...', ... }
 */
 ...
 * @param {string} options.from - Historical coin ID (e.g., 'roman_denarius')
 * @param {string} options.to - Target currency code (e.g., 'usd', 'eur', 'gbp')
 ...
 * @returns {Promise<Object>} Conversion result with context and sources
 */
 ...
 *
 * @param {Object} options
 * @param {string} options.from - Traditional unit ID (e.g., 'abra')
 * @param {string} options.to - Target unit code (e.g., 'kg', 'm', 'l')
 * @param {number} [options.amount=1] - Amount to convert
 * @returns {Promise<Object>} Conversion result with unit info
 */
